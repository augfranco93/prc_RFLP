...
dat<-read_csv("C:/Users/rramiro/Downloads/taxonomyAssignment_methylo/PCR-RFLP/Final_results-PCR-RFLP.csv")
#this is to remove an unneeded column
dat<-dat %>% select(-X1)
#this is just to make the names smaller
dat$Organism<-str_remove(dat$Organism,"Methylobacterium |Methylorubrum ")
...
# probably you need to replace Methylobacterium and Met
